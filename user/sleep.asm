...
main(int argc, char *argv[])
{
  ...
  16:	1c0080e7          	jalr	448(ra) # 1d2 <atoi>
  1a:	84aa                	mv	s1,a0

  fprintf(1,"User sleep for %d \n", time_to_sleep);
  1c:	862a                	mv	a2,a0
  1e:	00000597          	auipc	a1,0x0
  22:	78a58593          	addi	a1,a1,1930 # 7a8 <malloc+0x100>
  26:	4505                	li	a0,1
  28:	00000097          	auipc	ra,0x0
  2c:	594080e7          	jalr	1428(ra) # 5bc <fprintf>
  
  sleep(time_to_sleep);
  30:	8526                	mv	a0,s1
  32:	00000097          	auipc	ra,0x0
  36:	2b0080e7          	jalr	688(ra) # 2e2 <sleep>

  exit();
  3a:	00000097          	auipc	ra,0x0
  3e:	218080e7          	jalr	536(ra) # 252 <exit>
    fprintf(2, "Usage: sleep <time> \n");
  42:	00000597          	auipc	a1,0x0
  46:	74e58593          	addi	a1,a1,1870 # 790 <malloc+0xe8>
  4a:	4509                	li	a0,2
  4c:	00000097          	auipc	ra,0x0
  50:	570080e7          	jalr	1392(ra) # 5bc <fprintf>
    exit();
  54:	00000097          	auipc	ra,0x0
  58:	1fe080e7          	jalr	510(ra) # 252 <exit>
